...
set CommonCompilerFlags=-MT -nologo -EHsc -EHa- -Gm- -GR- -Od -Oi -WX -W4 -wd4456 -wd4201 -wd4100 -wd4189 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7 -Fmwin32_handmade.map 
