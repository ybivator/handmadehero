...
set CommonCompilerFlags=-MT -nologo -EHsc -EHa- -Gm- -GR- -Od -Oi -WX -W4 -wd4456 -wd4201 -wd4100 -wd4189 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7
...
cl %CommonCompilerFlags% ..\handmade\src\handmade.cpp -Fmhandmade.map -LD^
   ...
   -PDB:handmade_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~0,2%%time:~3,2%%time:~6,2%.pdb^
